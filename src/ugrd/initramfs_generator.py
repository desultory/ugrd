...
class InitramfsGenerator:
    ...
    def generate_init_funcs(self) -> None:
        ...
        out = [f"# Generated by UGRD v{self.version}"]
    ...
    def generate_init(self) -> None:
        ...
        init = [self['shebang']]
        init += [f'echo "Starting UGRD v{self.version}"']
        ...
        if self.included_functions:
            ...
            if self['imports'].get('custom_init'):
                custom_init.insert(2, f"echo 'Starting custom init, UGRD v{self.version}'")
