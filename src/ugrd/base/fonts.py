...
def _process_fonts_multi(self, font_name: str) -> None:
    ...
    if cleaned_font_name == self["default_font"]:
        ...
        self.logger.debug(f"Font lookup retured default font, trying to strip style specifiers: {c_(cleaned_font_name, 'yellow')}")
    ...
    font_path = _get_font_path(self, cleaned_font_name)
